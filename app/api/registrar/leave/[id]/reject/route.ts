// app/api/registrar/leave/[id]/reject/route.ts - COMPLETE FIXED VERSION
...
export async function POST(
  ...
  try {
    ...
    const newStatus = "Rejected_Registrar";
    ...
    await rtdb.ref(`notifications/${notificationId}`).set({
      ...
      message: `Your ${isOD ? "On Duty" : leaveRequest.leaveType} leave request has been rejected by Registrar. Reason: ${reason}`,
      type: "leave_rejected",
      isRead: false,
